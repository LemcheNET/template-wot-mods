...
Настройка мода.
  ...
  Все настройки мода находятся в файле: res_mods/0.9.13/scripts/client/gui/mods/mod_pmod.json, 
  либо в файлах внутри папки: res_mods/0.9.13/scripts/client/gui/mods/mod_pmod
