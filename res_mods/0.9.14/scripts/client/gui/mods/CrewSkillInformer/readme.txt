...
[Opis]
CrewSkillInformer jest modem dla WoT pokazującym umiejętności załogi w trakcie bitwy.
Od wersji 0.5 mod działa także w powtokach, ALE:
- powtóka musi być Twoja
- aby użyć go poprawnie, uruchom grę, wybierz dany pojazd w garażu (mod odczyta informacje o pojeździe i zapisze je do pliku cache)
- mod będzie pokazywać aktualne info zapisane w pliku cache - a nie z czasu, kiedy powtórka była nagrywana

[Instalacja]
Wypakuj archiwum i skopiuj do folderu z grą?

[Konfiguracja]
Plik konfiguracyjny to 'CrewSkillInformerConfig.json', który można znaleźć:
$\[WorldOfTanks folder gry]\res_mods\[wersja]\scripts\client\mods\CrewSkillInformer\

Opis kluczy/wartości pliku konfiguracyjnego:
* "ActivationKey" - określa przycisk klawiatury, który uaktywnia mod. Mod będzie widoczny gdy dany przycisk będzie wciśnięty. Domyślny klucz to "KEY_BACKSPACE", inne opcje to:
  "KEY_SPACE", "KEY_LSHIFT", "KEY_LALT", "KEY_CAPSLOCK", "KEY_LCONTROL", "KEY_BACKSPACE", "KEY_A", "KEY_B", "KEY_C", "KEY_D", "KEY_E", "KEY_F", "KEY_G", "KEY_H", "KEY_I", "KEY_J", "KEY_K", "KEY_L", "KEY_M", "KEY_N", "KEY_O", "KEY_P", "KEY_Q", "KEY_R", "KEY_S", "KEY_T", "KEY_U", "KEY_V", "KEY_W", "KEY_X", "KEY_Y", "KEY_Z", "KEY_1", "KEY_2", "KEY_3", "KEY_4", "KEY_5", "KEY_6", "KEY_7", "KEY_8", "KEY_9", "KEY_0", "KEY_NUMPAD1", "KEY_NUMPAD2", "KEY_NUMPAD3", "KEY_NUMPAD4", "KEY_NUMPAD5", "KEY_NUMPAD6", "KEY_NUMPAD7", "KEY_NUMPAD8", "KEY_NUMPAD9", "KEY_NUMPAD0", "KEY_NUMLOCK", "KEY_NUMPADCOMMA", "KEY_NUMPADENTER", "KEY_NUMPADEQUALS", "KEY_NUMPADMINUS", "KEY_NUMPADPERIOD", "KEY_NUMPADSLASH", "KEY_NUMPADSTAR"
  
* "PositionMode" - tu określasz miejsce pokazywania moda na ekranie bitwy. Od wersji 0.5 domyślne ustawienie to "CENTER". Inne opcje to:
————————————————————————————————————————————————————————————————————————
TOP-LEFT						TOP							TOP-RIGHT
LEFT			CENTER-LEFT		CENTER		CENTER-RIGHT	RIGHT
BOTTOM-LEFT		DEFAULT			BOTTOM						BOTTOM-RIGHT
...
* "deltaX"        : "0",
* "deltaY"        : "0" - deltaX i deltaY to współczynniki do kalibracji klucza "PositionMode". Mogą być użyte ze wszystkimi opcjami poza "DEFAULT" - nie bo nie.
Przykładowe ustawienie:
Aby ustawić mod na dole ekranu nad panelem z amunicją, (dla rozdzielczości monitora 1680 x 1050) wybierz:
"PositionMode" -> "BOTTOM" 
"deltaX" -> "0" 
"deltaY" -> "65"

* "WithEquipment" - to opcja, która dodatkowo pokazuje wyposażenie pojazdu, po wpisaniu wartości "YES". W innym wypadku użyj "NO". Domyślne jest "YES".

[Co dalej]
- poprawka błędów
- dodanie ikonki z "+" dla nie wybranej jeszcze umiejętności

[Log wersji]
v.0.5
- nowa szata graficzna autorstwa Dumadidaka
- poprawione wyświetlanie kolejności załogi
- zmienna przezroczystość aktywnych/nieaktywnych umiejętności
- wspoczynniki 'deltaX' i 'deltaY' dla kalibracji pozycji na ekranie
...
v.0.3
- poł przezroczyste tło
- pokazywanie wyposażenia pojazdu

v.0.2
- możliwość zmiany przez użytkownika przycisku aktywującego mod
- możliwość zmiany przez użytkownika pozycji moda na ekranie
