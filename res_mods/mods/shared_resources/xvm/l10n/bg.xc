 ...
 */
{
  "locale": {
    ...
    "token/services_inactive": "Мрежовите услуги недостъпни.&nbsp;&nbsp;<a href='#XVM_SITE_UNAVAILABLE#'><font size='11'>повече данни</font></a>",
    ...
    "CompleteCrew": "Свали целия екипаж",
    "ReserveFilter": "",
    "check_reserve_menu": "",
    ...
    "Error loading XVM config": "Грешка при зареждане на коментарите"
  }
}
