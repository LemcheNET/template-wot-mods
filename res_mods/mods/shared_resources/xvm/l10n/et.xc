{
  "locale": {
    ...
    "token/services_inactive": "Võrguteenused välja lülitatud.&nbsp;&nbsp;<a href='#XVM_SITE_INACTIVE#'><font size='11'>rohkem infot</font></a>",
    ...
    "token/time_left_warn": "Aega jäänud:<tab/><font color='#EEEE00'>{0}p {1}t {2}m</font>",
    "token/cnt": "Päringute arv:<tab/><font color='#EEEEEE'>{0}</font>",
    ...
    "Hide not available": "Peida mittesaadaval",
