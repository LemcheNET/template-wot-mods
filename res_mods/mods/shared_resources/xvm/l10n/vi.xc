{
  "locale": {
    ...
    "ver/newVersion": "Có bản cập nhật mới:<tab/><a href='#XVM_SITE_DL#'><font color='#00FF00'>v{0}</font></a>\n{1}",
    ...
    "token/services_inactive": "Dịch vụ hệ thống không hoạt động.&nbsp;&nbsp;<a href='#XVM_SITE_INACTIVE#'><font size='11'>chi tiết</font></a>",
