{
  "locale": {
    ...
    "camoCoeff": "Коефіцієнт маскування",
    "(m/sec)": "(м/сек)",
    "(sec)": "(с)",
    "(m)": "(м)",
    ...
    "token/time_left": "Залишилось:<tab/><font color='#EEEEEE'>{0}д. {1}год. {2}хв.</font>",
    "token/time_left_warn": "Залишилось:<tab/><font color='#EEEE00'>{0}д. {1}год. {2}хв.</font>",
    ...
    "Hide unavailable": "Приховати недоступні",
