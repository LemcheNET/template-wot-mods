 ...
 */
{
  "locale": {
    ...
    "token/time_left": "有効期間:<tab/><font color='#EEEEEE'>{0}日.{1}時間.{2}分</font>",
    "token/time_left_warn": "有効期間:<tab/><font color='#EEEE00'>{0}日.{1}時間.{2}分</font>",
    "token/cnt": "リクエスト数:<tab/><font color='#EEEEEE'>{0}</font>",
    ...
    "MultiXP": "",
    "NoMaster": "",
    "CompleteCrew": "全搭乗員を降ろす",
    "ReserveFilter": "",
    "check_reserve_menu": "",
    "uncheck_reserve_menu": "",
    "reserve_confirm_title": "",
    "reserve_confirm_message": "",
    "Network services unavailable": "ネットワーク利用不可",
    "Error loading comments": "XVM設定のロードでエラーが発生しました",
    "Error saving comments": "XVM設定のロードでエラーが発生しました",
    "Comments disabled": "",
    "Edit data": "データ無し",
    "Nick": "",
    "Group": "",
