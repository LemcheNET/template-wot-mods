 ...
 */
{
  "locale": {
    ...
    "camoCoeff": "Coeficiente del camuflaje",
    "general": "General",
    "armor": "Armadura",
    ...
    "token/cnt": "Número de solicitudes:<tab/><font color='#EEEEEE'>{0}</font>",
    ...
    "NonDomination": "Eliminar \"Dominación\"",
    ...
    "reserve_confirm_message": "¿Seguro que quieres marcar el tanquecomo reserva? Estará disponible a través de los filtros en carrusel.",
